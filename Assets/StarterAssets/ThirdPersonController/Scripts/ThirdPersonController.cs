    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                {
                    GlobalEvents.Publish(new ResetJumpEvent());
                    GlobalEvents.Publish(new ResetFreefallEvent());

                    _alreadyResetJump = true;
                    _alreadyInFreefall = false;
                }
